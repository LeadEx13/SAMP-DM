//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
//               ||_2011 - 2012 _|| <3c>
// Special Actions and Animations PACK.
// By Elmerz and help From Exterminator.
//-------------------------------------------------------
// For More Cool Scripts Visit http://elmerz.com/sa-mp
// E-Mail: Elmerz@mail.com
//-------------------------------------------------------
// This is Only a Free Script By Elmerz© Simple Scripting
// To Buy a Premium ONE visit http://elmerz.com/sa-mp/buy
// You Can Pay with paypal or visa card.
//-------------------------------------------------------
// DO NOT CLAIM THIS AS YOUR OWN SCRIPT! DO NOT
// RE-RELEASE IT! FEEL FREE TO EDIT IT!
//-------------------------------------------------------
// Elmerz© Simple Scripting 2011 - 2012 sa-mp 3c
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
//-------------------------------------------------
// Get a FREE chat ROOM for your SERVER!! FREE!!
// At  >>  http://elmerz.com/chat  <<
//-------------------------------------------------
...
public OnPlayerCommandText(playerid, cmdtext[])
{
    ...
    if (strcmp("/robman", cmdtext, true) == 0) {
        ...
        // We Don't have anything here to use in cars.
        return 0;
	}
